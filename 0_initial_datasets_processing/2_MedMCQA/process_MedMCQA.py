...
# TODO: only retrieve the dev set - done
...
with open('2_MedMCQA_dev.csv', 'w', newline='', encoding='utf-8') as csvfile:
    writer = csv.writer(csvfile)
    writer.writerow(['Question', 'Correct Answer', 'Correct Answer ID', 'Answer Options', 'Dataset', 'Choice Type'])
    writer.writerows(data)

print("CSV file '2_MedMCQA_dev.csv' created successfully.")